...
(function(d){var e=function(){function b(){this._listeners=[]}b.prototype.add=function(a){this._listeners.push(a)};b.prototype.remove=function(a){if("function"===typeof a)for(var f=this._listeners.length;0<f;f++){if(this._listeners[0]===a){this._listeners.splice(0,1);break}}else this._listeners=[]};b.prototype.trigger=function(){for(var a=[],f=0;f<arguments.length;f++)a[f-0]=arguments[f];for(var f={},b=this._listeners.slice(0),d=0,h=b.length;d<h;d++)b[d].apply(f,a||[])};return b}();d.TypedEvent=e})(events||
...
(function(d){var e=function(){function b(a,f,b){var g=this;void 0===b&&(b=[{url:"stun:stun.l.google.com:19302"},{url:"stun:stun2.l.google.com:19302"}]);this.onConnection=new events.TypedEvent;this.receiveSignalMessage=function(a,f){var b=g.connections[a]?!0:!1;f?"offer"==f.type?(b&&console.warn("Already have a connection with fromId!"),d.log("Received OFFER from",a,f),b=g.createPeer(a),b.answer(f),g.onConnection.trigger(b)):"answer"==f.type?b?(d.log("Received ANSWER from ",a,f),g.connections[a].setRemoteDescription(f)):
console.error("Received answer SDP from unknown peer: ",a):f.candidate?b?(d.debug("Received ICE candidate from",a,f),g.connections[a].addIceCandidate(f)):console.error("Received ICE candidate from unknown peer: ",a):console.warn("Received unexpected signal message ",f," from ",a):console.error("Received empty signalling message, error from server?")};this.id=f;this.connections={};this.rtcConfig={iceServers:b};this.signaller=new d.Signaller(a,f);this.signaller.onSignal.add(this.receiveSignalMessage)}
b.prototype.connectToServer=function(){return this.signaller.connect()};b.prototype.connect=function(a){if(a==this.id)return console.error("You can't connect to yourself!"),null;a=this.createPeer(a);a.call();return a};b.prototype.createPeer=function(a){var f=this;d.log("Creating peer for ",a);var b=new d.ExcessPeer(a,this.signaller,this.rtcConfig);this.connections[a]=b;b.onClose.add(function(){d.log("Connection to ",a,"closed, deleting peer");delete f.connections[a]});return b};b.prototype.joinRoom=
function(a){this.currentRoom=a;this.signaller.join(a)};b.prototype.requestRoom=function(a,f){this.signaller.discover(a,f)};return b}();d.ExcessClient=e})(excess||(excess={}));
...
d){a.socket.onOpen(function(){f=!0;a.socket.join("discovery",{},function(b){return a.addDiscoveryChannel(b)});b()});a.socket.onError(function(){f||(a.socket.reconnect=function(){},a.socket=null,d(Error("Failed to connect to signalling server!")))})})};b.prototype.join=function(a){var b=this;null==this.socket&&d.err("Connect the signalling server first!");"room:"+a!=this.currentRoom&&(this.currentRoom&&this.socket.leave(this.currentRoom,{}),this.socket.join("room:"+a,{user_id:this.id},function(d){return b.addChannel(a,
...
b.prototype.onError=function(a){if(a)return this.stateChangeCallbacks.error.push(a)};b.prototype.onMessage=function(a){if(a)return this.stateChangeCallbacks.message.push(a)};b.prototype.onConnOpen=function(){var a,b,d,g,h;clearInterval(this.reconnectTimer);this.transport.skipHeartbeat||(this.heartbeatTimer=setInterval(function(a){return function(){return a.sendHeartbeat()}}(this),this.heartbeatIntervalMs));this.rejoinAll();g=this.stateChangeCallbacks.open;h=[];b=0;for(d=g.length;b<d;b++)a=g[b],h.push(a());
return h};b.prototype.onConnClose=function(a){var b,d,g,h,e;this.log("WS close:");this.log(a);clearInterval(this.reconnectTimer);clearInterval(this.heartbeatTimer);this.reconnectTimer=setInterval(function(a){return function(){return a.reconnect()}}(this),this.reconnectAfterMs);h=this.stateChangeCallbacks.close;e=[];d=0;for(g=h.length;d<g;d++)b=h[d],e.push(b(a));return e};b.prototype.onConnError=function(a){var b,d,g,e,k;this.log("WS error:");this.log(a);e=this.stateChangeCallbacks.error;k=[];d=0;
for(g=e.length;d<g;d++)b=e[d],k.push(b(a));return k};b.prototype.connectionState=function(){var a;switch(null!=(a=this.conn)?a.readyState:void 0){case this.states.connecting:return"connecting";case this.states.open:return"open";case this.states.closing:return"closing";case this.states.closed:case null:return"closed"}};b.prototype.isConnected=function(){return"open"===this.connectionState()};b.prototype.rejoinAll=function(){var a,b,d,g,e;g=this.channels;e=[];b=0;for(d=g.length;b<d;b++)a=g[b],e.push(this.rejoin(a));
