...
function(a){this.currentRoom=a;this.signaller.join(a)};return b}();d.ExcessClient=e})(excess||(excess={}));
...
(function(d){var e=function(){function b(a,f){var b=this;this.onSignal=new events.TypedEvent;this.addChannel=function(a,f){b.signalChannel=f;b.currentRoom=f.topic;f.on("msg:user",function(a){b.onSignal.trigger(a.from,a.data)})};this.receiveDiscovery=function(a){b.discoveryCallbacks[a.r](a.users);delete b.discoveryCallbacks[a.r]};this.id=f;this.discoveryCallbacks={};this.endPoint=a}b.prototype.connect=function(){var a=this;this.socket=new Phoenix.Socket(this.endPoint);var b=!1;return new Promise(function(d,
g){a.socket.onOpen(function(){b=!0;a.socket.join("discovery",{},function(b){return a.addDiscoveryChannel(b)});d()});a.socket.onError(function(){b||(a.socket.reconnect=function(){},a.socket=null,g(Error("Failed to connect to signalling server!")))})})};b.prototype.join=function(a){var b=this;null==this.socket&&d.err("Connect the signalling server first!");"room:"+a!=this.currentRoom&&(this.currentRoom&&this.socket.leave(this.currentRoom,{}),this.socket.join("room:"+a,{user_id:this.id},function(d){return b.addChannel(a,
