...
(function(d){var e=function(){function b(a){var h=this;this.onMessage=new events.TypedEvent;this.onClose=new events.TypedEvent;this.onError=new events.TypedEvent;this.onOpen=new events.TypedEvent;this._onMessage=function(a){h.onMessage.trigger(JSON.parse(a.data))};this._onError=function(a){d.log("\nCHANNEL ERROR: ",a);h.onError.trigger(a)};this._onClose=function(a){d.log("\nCHANNEL CLOSE: ",a);h.onClose.trigger(a)};this._onOpen=function(a){d.log("\nCHANNEL OPEN: ",a);h.onOpen.trigger(a)};this.dataChannel=
a;this.attachCallbacks()}Object.defineProperty(b.prototype,"label",{get:function(){return this.dataChannel.label},enumerable:!0,configurable:!0});b.prototype.attachCallbacks=function(){this.dataChannel.onmessage=this._onMessage;this.dataChannel.onerror=this._onError;this.dataChannel.onclose=this._onClose;this.dataChannel.onopen=this._onOpen};b.prototype.send=function(a){a=JSON.stringify(a);this.dataChannel.send(a)};return b}();d.Channel=e})(excess||(excess={}));
...
this.onStateChange=function(a){d.log("Connection state change ",a)};this.onIceStateChange=function(a){};this.onIceCandidate=function(a){a.candidate&&f.signaller.signal(f.id,{sdpMLineIndex:a.candidate.sdpMLineIndex,sdpMid:a.candidate.sdpMid,candidate:a.candidate.candidate})};this.signaller=b;this.id=a;this.iceBuffer=[];this.channels={};this.connection=new RTCPeerConnection(k);this.connection.ondatachannel=function(a){f.addDataChannel(a.channel);f.onDataChannelReceive.trigger(f.channels[a.channel.label])};
this.connection.onicecandidate=this.onIceCandidate;this.connection.onstatechange=this.onStateChange;this.connection.oniceconnectionstatechange=this.onIceStateChange}b.prototype.call=function(){var a=this;this.createDataChannel("excess").onClose.add(function(){a.onClose.trigger()});this.caller=!0;this.connection.createOffer(this.onSDPCreate,this.onSDPError)};b.prototype.answer=function(a){var b=this;this.caller&&(this.caller=!1);this.setRemoteDescription(a,function(){return b.connection.createAnswer(b.onSDPCreate,
b.onSDPError)})};b.prototype.createDataChannel=function(a,b){void 0===b&&(b={});d.log("Creating data channel ",a," opts:",b);var k=this.connection.createDataChannel(a,b);return this.addDataChannel(k)};b.prototype.addDataChannel=function(a){var b=this;"object"!=typeof a&&console.error("Data channel is not even an object!");d.log("Added data channel ",a);var k=new d.Channel(a);this.channels[a.label]=k;this.channels[a.label].onClose.add(function(){return delete b.channels[a.label]});return k};b.prototype.addIceCandidate=
function(a){this.remoteDescriptionSet?(a=new RTCIceCandidate(a),this.connection.addIceCandidate(a)):(d.log("Buffering ICE candidate"),this.iceBuffer.push(a))};b.prototype.setRemoteDescription=function(a,b){var k=this;void 0===b&&(b=function(){});d.log("Attempting to set remote description.");var f=new RTCSessionDescription(a);this.connection.setRemoteDescription(f,function(){d.log("Set remote description",k.caller?"(ANSWER).":"(OFFER).");k.remoteDescriptionSet=!0;k.addIceBuffer();b.apply(k)},function(a){return console.error("Failed to set remote descr",
