...
a;this.attachCallbacks()}Object.defineProperty(b.prototype,"label",{get:function(){return this.dataChannel.label},enumerable:!0,configurable:!0});b.prototype.attachCallbacks=function(){this.dataChannel.onmessage=this._onMessage;this.dataChannel.onerror=this._onError;this.dataChannel.onclose=this._onClose;this.dataChannel.onopen=this._onOpen};b.prototype.send=function(a){this.dataChannel.send(JSON.stringify(a))};return b}();d.Channel=e})(excess||(excess={}));
