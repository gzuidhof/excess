...
{url:d[0],credential:b,username:e}}else a={url:d,credential:b,username:e};return a},window.createIceServers=function(d,e,b){for(var a=[],f=0;f<d.length;f++){var n=window.createIceServer(d[f],e,b);null!==n&&a.push(n)}return a},attachMediaStream=function(d,e){console.log("Attaching media stream");d.mozSrcObject=e},reattachMediaStream=function(d,e){console.log("Reattaching media stream");d.mozSrcObject=e.mozSrcObject};else if(navigator.webkitGetUserMedia){console.log("This appears to be Chrome");var webrtcDetectedBrowser=
...
function requestUserMedia(d){return new Promise(function(e,b){var a=function(a){e(a)},f=function(a){b(a)};try{getUserMedia(d,a,f)}catch(n){b(n)}})};var events;
(function(d){var e=function(){function b(){this._listeners=[]}b.prototype.add=function(a){this._listeners.push(a)};b.prototype.remove=function(a){if("function"===typeof a)for(var f=this._listeners.length;0<f;f++){if(this._listeners[0]===a){this._listeners.splice(0,1);break}}else this._listeners=[]};b.prototype.trigger=function(){for(var a=[],f=0;f<arguments.length;f++)a[f-0]=arguments[f];for(var f={},n=this._listeners.slice(0),b=0,d=n.length;b<d;b++)n[b].apply(f,a||[])};return b}();d.TypedEvent=e})(events||
(events={}));var excess;(function(d){d.log=console.log;d.err=console.error})(excess||(excess={}));var c,l;window.onload=function(){};
(function(d){var e=function(){function b(a){var f=this;this.onMessage=new events.TypedEvent;this.onClose=new events.TypedEvent;this.onError=new events.TypedEvent;this.onOpen=new events.TypedEvent;this._onMessage=function(a){d.log("\nCHANNEL MESSAGE: ",a.data);f.onMessage.trigger(a)};this._onError=function(a){d.log("\nCHANNEL ERROR: ",a);f.onError.trigger(a)};this._onClose=function(a){d.log("\nCHANNEL CLOSE: ",a);f.onClose.trigger(a)};this._onOpen=function(a){d.log("\nCHANNEL OPEN: ",a);f.onOpen.trigger(a)};
...
(function(d){var e=function(){function b(a,f,b){var g=this;void 0===b&&(b=[{url:"stun:stun.l.google.com:19302"},{url:"stun:stun2.l.google.com:19302"}]);this.receiveSignalMessage=function(a,f){var b=g.connections[a]?!0:!1;f?"offer"==f.type?(b&&console.warn("Already have a connection with fromId!"),d.log("Received OFFER from",a,f),g.createPeer(a).answer(f)):"answer"==f.type?b?(d.log("Received ANSWER from ",a,f),g.connections[a].setRemoteDescription(f)):console.error("Received answer SDP from unknown peer: ",
a):f.candidate?b?(d.log("Received ICE candidate from",a,f),g.connections[a].addIceCandidate(f)):console.error("Received ICE candidate from unknown peer: ",a):console.warn("Received unexpected signal message ",f," from ",a):console.error("Received empty signalling message, error from server?")};this.id=f;this.connections={};this.rtcConfig={iceServers:b};this.signaller=new d.Signaller(a,f);this.signaller.onSignal.add(this.receiveSignalMessage)}b.prototype.connect=function(a){if(a==this.id)return console.error("You can't connect to yourself!"),
null;a=this.createPeer(a);a.call();return a};b.prototype.createPeer=function(a){var f=this;d.log("Creating peer for ",a);var b=new d.ExcessPeer(a,this.signaller,this.rtcConfig);this.connections[a]=b;b.onClose.add(function(){d.log("Connection to ",a,"closed, deleting peer");delete f.connections[a]});return b};b.prototype.joinRoom=function(a){this.currentRoom=a;this.signaller.join(a)};return b}();d.ExcessClient=e})(excess||(excess={}));
(function(d){var e=function(){function b(a,f,b){var g=this;this.remoteDescriptionSet=this.caller=!1;this.onClose=new events.TypedEvent;this.onSDPCreate=function(a){g.connection.setLocalDescription(a,g.onLocalDescrAdded,function(){return d.log("Failed to set local description!")});g.signaller.signal(g.id,a)};this.onSDPError=function(a){console.error(a)};this.onLocalDescrAdded=function(){d.log("Set local description ",g.caller?"(OFFER).":"(ANSWER).")};this.onStateChange=function(a){d.log("Connection state change ",
a)};this.onIceStateChange=function(a){d.log("ICE state changed: connection:",g.connection.iceConnectionState,"gathering:",g.connection.iceGatheringState)};this.onIceCandidate=function(a){a.candidate&&g.signaller.signal(g.id,{sdpMLineIndex:a.candidate.sdpMLineIndex,sdpMid:a.candidate.sdpMid,candidate:a.candidate.candidate})};this.signaller=f;this.id=a;this.iceBuffer=[];this.channels={};this.connection=new RTCPeerConnection(b);this.connection.ondatachannel=function(a){return g.addDataChannel(a.channel)};
this.connection.onnegotiationneeded=function(a){return console.warn("Negotation needed!")};this.connection.onicecandidate=this.onIceCandidate;this.connection.onstatechange=this.onStateChange;this.connection.oniceconnectionstatechange=this.onIceStateChange}b.prototype.call=function(){this.createDataChannel("excess");this.caller=!0;this.connection.createOffer(this.onSDPCreate,this.onSDPError)};b.prototype.answer=function(a){var f=this;this.caller&&(this.caller=!1);this.setRemoteDescription(a,function(){return f.connection.createAnswer(f.onSDPCreate,
f.onSDPError)})};b.prototype.createDataChannel=function(a,f){void 0===f&&(f={});d.log("Creating data channel ",a," opts:",f);var b=this.connection.createDataChannel(a,f);return this.addDataChannel(b)};b.prototype.addDataChannel=function(a){var f=this;"object"!=typeof a&&console.error("Data channel is not even an object!");d.log("Added data channel ",a);var b=new d.Channel(a);l=b;this.channels[a.label]=b;this.channels[a.label].onClose.add(function(){return delete f.channels[a.label]});return b};b.prototype.addIceCandidate=
function(a){this.remoteDescriptionSet?(a=new RTCIceCandidate(a),this.connection.addIceCandidate(a)):(d.log("Buffering ICE candidate"),this.iceBuffer.push(a))};b.prototype.setRemoteDescription=function(a,f){var b=this;void 0===f&&(f=function(){});d.log("Attempting to set remote description.");var g=new RTCSessionDescription(a);this.connection.setRemoteDescription(g,function(){d.log("Set remote description",b.caller?"(ANSWER).":"(OFFER).");b.remoteDescriptionSet=!0;b.addIceBuffer();f.apply(b)},function(a){return console.error("Failed to set remote descr",
...
(function(d){var e=function(){function b(a,f){var b=this;this.onSignal=new events.TypedEvent;this.addChannel=function(a,f){b.signalChannel=f;b.currentRoom=f.topic;f.on("msg:user",function(a){b.onSignal.trigger(a.from,a.data)})};this.receiveDiscovery=function(a){b.discoveryCallbacks[a.r](a.users);delete b.discoveryCallbacks[a.r]};this.id=f;this.discoveryCallbacks={};this.socket=new Phoenix.Socket(a);this.socket.join("discovery",{},function(a){return b.addDiscoveryChannel(a)})}b.prototype.join=function(a){var b=
this;"room:"+a!=this.currentRoom&&(this.currentRoom&&this.socket.leave(this.currentRoom,{}),this.socket.join("room:"+a,{user_id:this.id},function(d){return b.addChannel(a,d)}))};b.prototype.addDiscoveryChannel=function(a){this.discoveryChannel=a;a.on("get:room",this.receiveDiscovery)};b.prototype.discover=function(a,b){var d=(new Date).getTime();this.discoveryCallbacks[d]=b;this.discoveryChannel.send("get:room",{id:a,r:d})};b.prototype.signal=function(a,b){d.log("Signalling to ",a,b);this.signalChannel.send("msg:user",
{to:a,data:b})};return b}();d.Signaller=e})(excess||(excess={}));(function(){(function(d,e){return"function"===typeof define&&define.amd?define(["phoenix"],e):"object"===typeof exports?e(exports):e(d.Phoenix={})})(this,function(d){var e;e=this;d.Channel=function(){function b(a,b,d,g){this.topic=a;this.message=b;this.callback=d;this.socket=g;this.reset()}b.prototype.bindings=null;b.prototype.reset=function(){return this.bindings=[]};b.prototype.on=function(a,b){return this.bindings.push({event:a,callback:b})};b.prototype.isMember=function(a){return this.topic===
a};b.prototype.off=function(a){var b,d,g,h,e;h=this.bindings;e=[];d=0;for(g=h.length;d<g;d++)b=h[d],b.event!==a&&e.push(b);return this.bindings=e};b.prototype.trigger=function(a,b){var d,g,h,e,m,p;m=this.bindings;p=[];h=0;for(e=m.length;h<e;h++)d=m[h],g=d.event,d=d.callback,g===a&&p.push(d(b));return p};b.prototype.send=function(a,b){return this.socket.send({topic:this.topic,event:a,payload:b})};b.prototype.leave=function(a){null==a&&(a={});this.socket.leave(this.topic,a);return this.reset()};return b}();
d.Socket=function(){function b(a,b){var n,g,h,k;null==b&&(b={});this.states=d.Socket.states;this.transport=null!=(n=null!=(g=b.transport)?g:e.WebSocket)?n:d.LongPoller;this.heartbeatIntervalMs=null!=(h=b.heartbeatIntervalMs)?h:this.heartbeatIntervalMs;this.logger=null!=(k=b.logger)?k:function(){};this.endPoint=this.expandEndpoint(a);this.channels=[];this.sendBuffer=[];this.stateChangeCallbacks={open:[],close:[],error:[],message:[]};this.resetBufferTimer();this.reconnect()}b.states={connecting:0,open:1,
...
return h};b.prototype.rejoin=function(a){a.reset();this.send({topic:a.topic,event:"join",payload:a.message});return a.callback(a)};b.prototype.join=function(a,b,e){a=new d.Channel(a,b,e,this);this.channels.push(a);if(this.isConnected())return this.rejoin(a)};b.prototype.leave=function(a,b){var d;null==b&&(b={});this.send({topic:a,event:"leave",payload:b});var e,h,k,m;k=this.channels;m=[];e=0;for(h=k.length;e<h;e++)d=k[e],d.isMember(a)||m.push(d);return this.channels=m};b.prototype.send=function(a){var b;
b=function(b){return function(){return b.conn.send(JSON.stringify(a))}}(this);return this.isConnected()?b():this.sendBuffer.push(b)};b.prototype.sendHeartbeat=function(){return this.send({topic:"phoenix",event:"heartbeat",payload:{}})};b.prototype.flushSendBuffer=function(){var a,b,d,e;if(this.isConnected()&&0<this.sendBuffer.length){e=this.sendBuffer;b=0;for(d=e.length;b<d;b++)a=e[b],a();this.sendBuffer=[]}return this.resetBufferTimer()};b.prototype.onConnMessage=function(a){var b,d,e,h,k,m,p;this.log("message received:");
this.log(a);d=JSON.parse(a.data);e=d.topic;a=d.event;d=d.payload;m=this.channels;h=0;for(k=m.length;h<k;h++)b=m[h],b.isMember(e)&&b.trigger(a,d);m=this.stateChangeCallbacks.message;p=[];h=0;for(k=m.length;h<k;h++)b=m[h],p.push(b(e,a,d));return p};return b}();d.LongPoller=function(){function b(a){this.states=d.Socket.states;this.upgradeEndpoint=this.normalizeEndpoint(a);this.pollEndpoint=this.upgradeEndpoint+(/\/$/.test(a)?"poll":"/poll");this.readyState=this.states.connecting;this.open()}b.prototype.retryInMs=
...
"https://")};b.prototype.poll=function(){if(this.readyState===this.states.open)return d.Ajax.request("GET",this.pollEndpoint,"application/json",null,function(a){return function(b,d){var e,h,k,m;switch(b){case 200:m=JSON.parse(d);h=0;for(k=m.length;h<k;h++)e=m[h],a.onmessage({data:JSON.stringify(e)});return a.poll();case 204:return a.poll();default:return a.close(),setTimeout(function(){return a.open()},a.retryInMs)}}}(this))};b.prototype.send=function(a){return d.Ajax.request("POST",this.pollEndpoint,
"application/json",a,function(a){return function(b,d){if(200!==b)return a.onerror()}}(this))};b.prototype.close=function(a,b){this.readyState=this.states.closed;return this.onclose()};return b}();d.Ajax={states:{complete:4},request:function(b,a,d,n,g){var h;h=null!=e.XMLHttpRequest?new e.XMLHttpRequest:new e.ActiveXObject("Microsoft.XMLHTTP");h.open(b,a,!0);h.setRequestHeader("Content-type",d);h.onreadystatechange=function(a){return function(){if(h.readyState===a.states.complete)return"function"===
typeof g?g(h.status,h.responseText):void 0}}(this);return h.send(n)}};return d})}).call(this);
