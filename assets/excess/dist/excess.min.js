...
(function(d){var e=function(){function b(a){var h=this;this.onMessage=new events.TypedEvent;this.onClose=new events.TypedEvent;this.onError=new events.TypedEvent;this.onOpen=new events.TypedEvent;this._onMessage=function(a){d.log("\nCHANNEL MESSAGE: ",a.data);h.onMessage.trigger(a.data)};this._onError=function(a){d.log("\nCHANNEL ERROR: ",a);h.onError.trigger(a)};this._onClose=function(a){d.log("\nCHANNEL CLOSE: ",a);h.onClose.trigger(a)};this._onOpen=function(a){d.log("\nCHANNEL OPEN: ",a);h.onOpen.trigger(a)};
this.dataChannel=a;this.attachCallbacks()}Object.defineProperty(b.prototype,"label",{get:function(){return this.dataChannel.label},enumerable:!0,configurable:!0});b.prototype.attachCallbacks=function(){this.dataChannel.onmessage=this._onMessage;this.dataChannel.onerror=this._onError;this.dataChannel.onclose=this._onClose;this.dataChannel.onopen=this._onOpen};b.prototype.send=function(a){this.dataChannel.send(a)};return b}();d.Channel=e})(excess||(excess={}));
