...
d){a.socket.onOpen(function(){f=!0;a.socket.join("discovery",{},function(f){a.addDiscoveryChannel(f);b()})});a.socket.onError(function(){f||(a.socket.reconnect=function(){},a.socket=null,d(Error("Failed to connect to signalling server!")))})})};b.prototype.join=function(a){var f=this;null==this.socket&&d.err("Connect the signalling server first!");"room:"+a!=this.currentRoom&&(this.currentRoom&&this.socket.leave(this.currentRoom,{}),this.socket.join("room:"+a,{user_id:this.id},function(b){return f.addChannel(a,
