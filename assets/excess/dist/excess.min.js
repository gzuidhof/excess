...
(function(c){var d=function(){function b(a,e,b){var f=this;void 0===b&&(b=[{url:"stun:stun.l.google.com:19302"},{url:"stun:stun2.l.google.com:19302"}]);this.receiveSignalMessage=function(a,e){var b=f.connections[a]?!0:!1;e?"offer"==e.type?(b&&console.warn("Already have a connection with fromId!"),c.log("Received OFFER from",a,e),f.createPeer(a).answer(e)):"answer"==e.type?b?(c.log("Received ANSWER from ",a,e),f.connections[a].setRemoteDescription(e)):console.error("Received answer SDP from unknown peer: ",
...
(function(c){var d=function(){function b(a,e,b){var f=this;this.remoteDescriptionSet=this.caller=!1;this.onClose=new events.TypedEvent;this.onDataChannelReceive=new events.TypedEvent;this.onSDPCreate=function(a){f.connection.setLocalDescription(a,f.onLocalDescrAdded,function(){return c.err("Failed to set local description!")});f.signaller.signal(f.id,a)};this.onSDPError=function(a){console.error(a)};this.onLocalDescrAdded=function(){c.log("Set local description ",f.caller?"(OFFER).":"(ANSWER).")};
